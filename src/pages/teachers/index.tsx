...
import { useRoqClient, useTeacherFindManyWithCount } from 'lib/roq';
...
export function TeacherListPage(props: TeacherListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['subject.contains', 'class.contains', 'section.contains'],
          ...params.filters,
        },
        'teacher',
      ),
  ...
  const { data, error, isLoading, mutate } = useTeacherFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.teacher.delete({ where: { id } });
      await mutate();
    } catch (error) {
