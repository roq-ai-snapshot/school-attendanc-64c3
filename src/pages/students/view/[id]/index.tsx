...
import { useStudentFindFirst } from 'lib/roq';
...
function StudentViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; school: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useStudentFindFirst(queryParams, {}, { disabled: !id });
